  ...
  return (
    ...
    <div className=" text-center pt-40 bg-[url('https://img.freepik.com/free-vector/technology-wire-mesh-network-connection-digital-background_1017-28407.jpg')] bg-fixed md:px-44 py-40 bg-cover rounded-b-[15%] lg:text-center">
       ...
       <div className=" text-center pt-5 items-center">
             <h1 className="font-bold text-4xl pt-10">Our Courses!
           ...
           {/* first */}
       <div className="max-w-[1200px]  mx-auto py-[50px] p-5 grid lg:grid-col-4 sm:grid-cols-2 gap-6">
       ...
       <div className=" hover:animate-bounce shadow-2xl rounded-lg p-4 text-center bg-pink-500 hover:text-black  text-white ">
        ...
        GETTING PAKISTAN READY FOR THE NEW ERA OF MICROSERVICES AND MULTI-CLOUD NATIVE COMPUTING.</p>
         ...
         <div className=" hover:animate-bounce shadow-2xl rounded-lg p-4 justify-items-center text-center hover:text-black text-white bg-yellow-500 ">
        
        <h2 className="font-bold p-5 text-2xl">BLOCKCHAIN</h2>
        <p className="p-5">A ONE YEAR BLOCKCHAIN PROGRAM DESIGNED FOR ABSOLUTE BEGINNERS GETTING PAKISTAN READY FOR THE NEW ERA OF BLOCKCHAIN, FINTECH AND SMART CONTRACTS.</p>
         </div>
         {/* four */}

         <div className="hover:animate-bounce shadow-2xl rounded-lg p-4 text-center hover:text-black text-white bg-purple-500 ">
         
        <h2 className="font-bold p-5 text-2xl">Artificial Inteligence</h2>
        <p className="p-5">A ONE YEAR AI PROGRAM DESIGNED FOR ABSOLUTE BEGINNERS.
         GETTING PAKISTAN READY FOR THE NEW ERA OF COMPUTING ENABLED BY THE RISE OF AI.</p>
         </div>
       </div>
